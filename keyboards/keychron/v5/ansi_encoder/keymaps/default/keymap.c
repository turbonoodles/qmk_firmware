...
#define QSPEC XP(RGB_MOD, RGB_RMOD)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_ansi_98(
        ...
        _______,  X(BANG),  _______,       _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,            _______,  _______,  _______,  _______,
        RGB_TOG,    QSPEC,  XP(omeg,OMEG), RGB_HUI,  RGB_SAI,  RGB_SPI,  _______, X(MICRO),  _______,  _______,  XP(pi,PI),  _______,    _______,  _______,            _______,  _______,  _______,
        _______, X(alpha),  XP(sgma,SGMA), RGB_HUD,  RGB_SAD,  RGB_SPD,  _______,  _______,  X(kapa),  X(lbda),  _______,  _______,              _______,            _______,  _______,  _______,  _______,
        _______,            XP(OHM,zeta),   X(chi),  XP(cced,CCED),  _______,  X(beta),   X(eta),  NK_TOGG,  _______,  _______,  _______,              _______,  KC_PGUP,  _______,  _______,  _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,    _______,  _______,  KC_PGDN,  _______,  _______,  _______,  _______),
};
